...
namespace Primo_y_Fibonacci
{
    public partial class Categoria : Form
    {
        ...
        void mostrarDatos()
        {
            ...
            {
                MessageBox.Show("No hay Datos que mostrar", "Registros de Categorias",
        ...
        void controles(Boolean valor)
        {
            ...
            GrbDatoscategoria.Enabled = !valor;
        }
        ...
        {
            if (MessageBox.Show("Esta seguro de eliminar a " + txtcategoria.Text, "Registro de Categorias",
        ...
        {
            Busqueda_Categoria frmBusqueda = new Busqueda_Categoria();
            frmBusqueda.ShowDialog();

            if (frmBusqueda._IdCategoria > 0)
            {
                posicion = tbl.Rows.IndexOf(tbl.Rows.Find(frmBusqueda._IdCategoria));
                mostrarDatos();
            }
        }
